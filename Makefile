...
pkgdatadir = $(datadir)/PyPAM
pkglibdir = $(libdir)/PyPAM
pkgincludedir = $(includedir)/PyPAM
...
PYTHON_INCLUDES = -I/usr/include/python1.5 -I/usr/lib/python1.5/config
PYTHON_LINK = gcc -shared -o $@
SO = .so
VERSION = 0.4.0
pyexecdir = /usr/lib/python1.5/site-packages
pythondir = /usr/lib/python1.5/site-packages

SHELL = /bin/bash

EXTRA_DIST = PyPAM.spec

INCLUDES = $(PYTHON_INCLUDES) $(PYTHON_CFLAGS)

pyexec_PROGRAMS = PAMmodule$(SO)
PAMmodule__SO__SOURCES = PAMmodule.c
PAMmodule__SO__LDADD = -lpam -lpam_misc
PAMmodule__SO__LINK = $(PYTHON_LINK)
...
DEFS =  -DPACKAGE=1 -DVERSION=1  -I. -I$(srcdir) 
CPPFLAGS = 
LDFLAGS = 
LIBS = 
PAMmodule__SO__OBJECTS =  PAMmodule.o
PAMmodule__SO__DEPENDENCIES = 
PAMmodule__SO__LDFLAGS = 
CFLAGS = 
...
TAR = tar
GZIP_ENV = --best
DEP_FILES =  .deps/PAMmodule.P
SOURCES = $(PAMmodule__SO__SOURCES)
OBJECTS = $(PAMmodule__SO__OBJECTS)
...
PAMmodule$(SO): $(PAMmodule__SO__OBJECTS) $(PAMmodule__SO__DEPENDENCIES)
	@rm -f PAMmodule$(SO)
	$(PAMmodule__SO__LINK) $(PAMmodule__SO__LDFLAGS) $(PAMmodule__SO__OBJECTS) $(PAMmodule__SO__LDADD) $(LIBS)
...
clean-am:  clean-pyexecPROGRAMS clean-compile clean-tags clean-depend \
		clean-generic mostlyclean-am

clean: clean-am

distclean-am:  distclean-pyexecPROGRAMS distclean-compile distclean-tags \
